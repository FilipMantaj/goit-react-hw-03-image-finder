...
export const App = () => {
  ...
  const fetchData = async () => {
    const query = `https://pixabay.com/api/?q=${searchValue}&page=${currentPage}&key=44152366-9c3cf08325357e94ad545cff8&image_type=photo&orientation=horizontal&per_page=12`;
    try {
